...
<body>
    <div class="container" style="width: 500px;">
        ...
        <p style="font-size: 0.9em; color: gray;">Gra zostanie automatycznie dodana do Twojej kolekcji jako "Posiadam".</p>
        ...
        <form action="dodaj_gre.php" method="POST">
            ...
            <button type="submit">Zapisz i dodaj do kolekcji</button>
        </form>
    </div>
</body>
</html>
